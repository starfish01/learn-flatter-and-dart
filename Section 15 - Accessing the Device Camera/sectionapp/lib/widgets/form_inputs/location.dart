...
//         {'address': address, 'key': 'AIzaSyADQ5Fu-OwDVKjaM5pkkLWoVa1wteIaNgU'},
//       );
...
//           StaticMapProvider('AIzaSyADQ5Fu-OwDVKjaM5pkkLWoVa1wteIaNgU');
...
//         'key': 'AIzaSyADQ5Fu-OwDVKjaM5pkkLWoVa1wteIaNgU'
//       },
//     );
//     final http.Response response = await http.get(uri);
//     final decodedResponse = json.decode(response.body);
